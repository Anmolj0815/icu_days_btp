...
class ICUData(BaseModel):
    ...
    preop_alb: Optional[float] = Field(None, description="Pre-op Albumin (Corrected Name).") 
    ...
    intraop_rbc: Optional[float] = None 
    intraop_ffp: Optional[float] = None 
    
    # ADDED NEW INTRA-OP DRUGS/AGENTS
    intraop_ftn: Optional[float] = None 
    intraop_mdz: Optional[float] = None 
    intraop_vecu: Optional[float] = None 
    intraop_rocu: Optional[float] = None 
    intraop_eph: Optional[float] = None 
    intraop_epi: Optional[float] = None 
    intraop_phe: Optional[float] = None 
    intraop_ppf: Optional[float] = None 
    intraop_ca: Optional[float] = None 
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "preop_k": 4.8, "preop_cl": 105.0, "preop_glucose": 120.0, "preop_alb": 3.0, 
