    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "blood_prod": "None", "asa": 3.0, "preop_ecg": "Atrial fibrillation, controlled rate",
                "preop_pft": "Normal", "dx": "Mitral valve regurgitation", "opname": "Valve Repair",
                ...
                "preop_pt": 15.0, "preop_ptt": 40.0, "preop_ph": 7.35, "preop_pao2": 80.0,
                "preop_paco2": 45.0, "preop_o2sat": 95.0, "preop_hco3": 26.0, "preop_be": -1.0,
                "cline2": "Patient is frail", "intraop_sbp_min": 85.0, "intraop_dbp_min": 45.0,
                "intraop_pr_min": 70.0, "intraop_ebl": 500.0, "urine_output": 100.0, "postop_hb": 9.5,
                "postop_wbc": 14.0, "postop_cr": 1.8, "cardiac_risk": 4.0, "renal_function_status": "CKD Stage 3",
                "liver_function_status": "Normal", "preop_diabetes": "Y", "preop_htn": "Y",
                "preop_copd": "N", "preop_chf": "Y", "ventilation_mode": "SIMV", "muscle_relaxant": "Vecuronium",
                "opioid_used": "Morphine", "antibiotic_prophylaxis": "Vancomycin", "surgeon_id": "S105",
